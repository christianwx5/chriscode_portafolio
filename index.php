...
<meta name="description" content="Brando is a completely modern, feature-rich, professionally designed, fully responsive and multipurpose onepage WordPress theme.">
<meta name="keywords" content="WordPress, theme, CMS, agency, blog, bootstrap, creative, html5, multipurpose, onepage, art, photography, portfolio, responsive, resume, travel, architecture, restaurant, freelancer, personal, spa, beauty salon, corporate, wedding, landing page, tattoo, event landing page">
<title>Brando Responsive &amp; Multipurpose OnePage WordPress Theme &#8211; Personal Resume / vCard</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 navbar-header margin-ten-bottom sm-no-margin">
                                ...
                                <span class="icon-bar"></span>
                                                                            ...
                                                                            <img alt="Brando Responsive &amp; Multipurpose OnePage WordPress Theme" src="imagen/logo2.png" class="logo" />
                                                                            <img alt="Brando Responsive &amp; Multipurpose OnePage WordPress Theme" src="imagen/logo2.png" class="retina-logo"  style="top: -6px" />
                                                                        </a>
                                            </div>
                    <div class="col-md-12 margin-fifteen-tb sm-no-margin navigation-menu-wrap">
                        ...
                        if (isset($_REQUEST['num_proy'])){
                            ...
                            <li id="menu-item-3079" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3079"><a href="#logros" class="section-link">Logros</a></li>
                            <li id="menu-item-3081" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3081"><a href="#employment" class="section-link">Empleos</a></li>
...
-->
                                ...
                                <div id="custom_html-2" class="widget_text custom-widget widget_custom_html"><div class="textwidget custom-html-widget"><div class="footer-social margin-fifteen-top xs-margin-ten-top col-md-12 no-padding-lr"><a target="_blank" class="directpage enlace-off" href="#" rel="noopener noreferrer"><i class="fab fa-facebook-f icon"></i></a><a target="_blank" class="directpage enlace-off" href="#" rel="noopener noreferrer"><i class="fab fa-twitter"></i></a>
<a target="_blank" class="directpage enlace-off" href="#" rel="noopener noreferrer"><i class="fab fa-google-plus-g"></i></a><a target="_blank" class="directpage enlace-off" href="#" rel="noopener noreferrer"><i class="fab fa-linkedin-in"></i></a></div></div></div>                            </div>
                                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="row footer-border border-bottom padding-five-tb">
                    ...
                    <?php 
                        ...
                        if (isset($_REQUEST['num_proy'])){
                            ...
                            <a href="#"  rel="noopener noreferrer" class="enlace-off"><i class="fab fa-facebook-f"></i></a>
                            <a href="#"  rel="noopener noreferrer" class="enlace-off"><i class="fab fa-twitter"></i></a>
                            <a href="#"  rel="noopener noreferrer" class="enlace-off"><i class="fab fa-google-plus-g"></i></a>
                            <a href="#"  rel="noopener noreferrer" class="enlace-off"><i class="fab fa-dribbble"></i></a>
                            <a href="#"  rel="nofollow noopener noreferrer" class="enlace-off"><i class="fab fa-youtube"></i></a>
                            <a href="#"  rel="noopener noreferrer" class="enlace-off"><i class="fab fa-linkedin-in"></i></a>
                            </div>');
                        }else {
                            echo ('<div class="footer-social position-relative top4">
                            <a href="#" target="_blank" rel="noopener noreferrer" class="enlace-off"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" target="_blank" rel="noopener noreferrer" class="enlace-off"><i class="fab fa-twitter"></i></a>
                            <a href="#" target="_blank" rel="noopener noreferrer" class="enlace-off"><i class="fab fa-google-plus-g"></i></a>
                            <a href="#" target="_blank" rel="noopener noreferrer" class="enlace-off"><i class="fab fa-dribbble"></i></a>
                            <a href="#" target="_blank" rel="nofollow noopener noreferrer" class="enlace-off"><i class="fab fa-youtube"></i></a>
                            <a href="#" target="_blank" rel="noopener noreferrer" class="enlace-off"><i class="fab fa-linkedin-in"></i></a>
                            </div>');
                        }
                    ...
                    <a href="#home" class="inner-link">
                                                        <img src="imagen/logo2.png" alt="footer-logo"/>
                                            </a>
                </div>
                    </div>
    </div>
